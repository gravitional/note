...
\begin{tikzpicture}
    ...
    \path (12,-4) pic { figQrkSeaA = {$(e)$}{$u$}{$d$}{$u$}{$s$} };
    \path (18,-4) pic { figQrkSeaB = {$(f)$}{$u$}{$d$}{$u$}{$s$} };
    %
    \path (0,-8) pic { figQrkSeaA = {$(g)$}{$d$}{$u$}{$u$}{$u$} };
    \path (6,-8) pic { figQrkSeaB = {$(h)$}{$d$}{$u$}{$u$}{$u$} };
    \path (12,-8) pic { figQrkSeaA = {$(i)$}{$d$}{$u$}{$u$}{$s$} };
    \path (18,-8) pic { figQrkSeaB = {$(j)$}{$d$}{$u$}{$u$}{$s$} };
\end{tikzpicture}
